...
import { ArrowUpRight, ShieldCheck, Users, Video, Wallet } from "lucide-react";
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {p.stage === "verification" && p.verificationPhoto && (
            <span
              className="inline-flex items-center gap-1 rounded-full border border-ok/30 bg-ok/10 px-2 py-1 text-[11px] font-medium text-ok"
              title="Outcome verified with proof-of-completion evidence"
            >
              <ShieldCheck size={11} />
              Verified
            </span>
